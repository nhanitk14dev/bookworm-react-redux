...
export function* updateUserDetail(action: IAction<any>): Generator<any> {
  try {
    const response = yield call(
      createApiCall, {
      path: updateUserDetailRouteApi(action.payload.id),
...
export function* addUser(action: IAction<any>): Generator<any> {
  try {
    const response = yield call(
      createApiCall, {
